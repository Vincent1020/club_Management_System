...
export default {
  data() {
    return {
      ...
      // 前端提供的圖片映射
      clubImages: {
        '辯論社': 'https://www.penghutimes.com/FileUploads/ArticlePhoto/20220405091650268.jpg',
        '籃球社': 'https://freshman.cmu.edu.tw/new/sites/default/files/u21/%E7%B1%83%E7%90%83%E7%A4%BE%282%29-1%20-%20105007017%20105a-_0.jpg',
        '桌球社': 'https://ydweb.yuda.tyc.edu.tw/Page/BBP/BBP_Upload/431/20044/item00_20210610113556.jpg',
        // 暫時用相同的圖片作為其他社團的佔位符
